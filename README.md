...
Một số chức năng cần kết nối API. Nên lưu API key trong file cấu hình riêng:

```javascript
const WEATHER_API_KEY = "YOUR_API_KEY";
```

Không nên đưa API key thật lên GitHub. Có thể thêm file chứa khóa API vào `.gitignore`.
